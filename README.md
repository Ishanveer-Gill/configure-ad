...
<p>  
  Create a new File and paste the contents of this script (https://github.com//Ishanveer-Gill/Coursecareers-code into it:
</p>
<p>
...
<p>
  When finished, open ADUC and observe the accounts in the correct OU and attempt to log into Client-1 with one of the accounts (take note of the password in the script):
</p>
<p>
